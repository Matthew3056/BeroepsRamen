...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($subject) || empty($message)) {
        ...
        // Hier zou je normaal een e-mail versturen of het bericht opslaan in de database
        // Voor dit voorbeeld tonen we alleen een succesmelding
...
<div class="container">
        ...
        <div class="contact-info">
            ...
            <div class="contact-item">
                ...
                <div class="contact-details">
                    <h3>Adres</h3>
                    <p>Huydecoperstraat 23-A<br>3151 NC Hoek van Holland</p>
                </div>
            </div>
    ...
    <div class="contact-map">
        ...
        <div class="map-container">
            <iframe 
                src="https://www.google.com/maps?q=Huydecoperstraat+23-A,+3151+NC+Hoek+van+Holland&output=embed" 
                width="100%" 
                height="450" 
                style="border:0;" 
                allowfullscreen="" 
                ...
                title="Locatie Ramen Delivery - Huydecoperstraat 23-A, Hoek van Holland">
            </iframe>
        </div>
    </div>
</div>
